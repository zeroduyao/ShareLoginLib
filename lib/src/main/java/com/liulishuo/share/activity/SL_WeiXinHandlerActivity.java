 ...
 */
public class SL_WeiXinHandlerActivity extends Activity  {
    ...
    *//**
    ...
    @NonNull
    private SendMessageToWX.Req createShareRequest(@NonNull ShareContent shareContent, String shareType) {
        // 建立信息体
